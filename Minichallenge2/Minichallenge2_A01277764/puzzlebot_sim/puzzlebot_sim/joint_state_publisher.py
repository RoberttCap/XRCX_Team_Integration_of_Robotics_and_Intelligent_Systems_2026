...
class PuzzlebotPublisher(Node):
    ...
    def timer_cb(self):
        ...
        # Calculate wheel angular velocities for circular motion
        omega_r = (v + self.omega * self.wheel_base / 2) / self.wheel_radius
        omega_l = (v - self.omega * self.wheel_base / 2) / self.wheel_radius
