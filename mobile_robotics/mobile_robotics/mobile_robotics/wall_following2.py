...
class LaserScanSub(Node): 
    ...
    def __init__(self): 
        ...
        self.pub_cmd_vel = self.cmd_vel_pub
        self.lidar = LaserScan() # Data from lidar will be stored here. 
        self.d_safety = 0.23 # Stop the robot whenever an object is this close 
        self.v = 0.20 # Linear speed to the front 
    ...
    def get_theta_fw(self, theta_ao, direction="fwcw"): 
        #This function takes as input the angle to the closest object 
        # Follows the wall to the left (direction="fwccw") or to the right (direction="fwcw") 
