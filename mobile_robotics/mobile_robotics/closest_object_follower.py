...
class LaserScanSub(Node): 
    def __init__(self): 
        ...
        #create publisher for cmd_vel and initialize the Twist message for velocity commands
        self.cmd_vel_pub = self.create_publisher(Twist, "cmd_vel", 10)
        self.robot_vel = Twist() # This will store the velocity command to be published.
        
        self.lidar = LaserScan() # Data from lidar will be stored here. 
        self.received_scan = False
        self.d_safety = .3 # Safety distance threshold meters
        self.get_kv = 0.5 #  linear velocity
        self.get_kw = 0.5 # angular velocity
    ...
    def get_closest_object(self):
        ...
        #limit theta_closest the angle to be between -pi and pi
