...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'avoid_obstacles = mobile_robotics.avoid_obstacles:main',
            'obstacle_avoidance = mobile_robotics.obstacle_avoidance:main',
            'wall_following = mobile_robotics.wall_following:main',
            'wall_following2 = mobile_robotics.wall_following2:main',
        ],
    },
)
